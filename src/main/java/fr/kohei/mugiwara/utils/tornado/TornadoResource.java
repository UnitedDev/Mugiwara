    ...
    public static void spawnTornado(
        ...
        class VortexBlock {
            ...
            public HashSet<VortexBlock> tick() {
                ...
                HashSet<VortexBlock> new_blocks = new HashSet<>();
        ...
        final HashSet<VortexBlock> clear = new HashSet<>();

        Material finalMaterial = material;
        final int id = new BukkitRunnable() {

            private final ArrayDeque<VortexBlock> blocks = new ArrayDeque<>();
            ...
            public void run() {
                ...
                for (int i = 0; i < 10; i++) {
                    checkListSize();
                    VortexBlock vb = new VortexBlock(location, finalMaterial, data);
                    blocks.add(vb);
                    clear.add(vb);
                }

                // Make all blocks in the list spin, and pick up any blocks that get in the way.
                ArrayDeque<VortexBlock> que = new ArrayDeque<>();
