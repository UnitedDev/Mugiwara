...
import fr.kohei.mugiwara.utils.other.ReflectionUtils;
import fr.kohei.mugiwara.utils.other.ReflectionUtils.PackageType;
import org.bukkit.*;
...
public enum ParticleEffect {
    ...
    public static void makeParticleLine(Location from, Location to) {
        ...
        for (double i = 0; i < distance; i += 0.1) {
            ...
            float r = (float) 51 / 255;
            float g = (float) 255 / 255;
            float b = (float) 51 / 255;
